...
function AmsterdamWeather () {

    const[weather,setWeather] = useState("")
 
    const getWeather = () => {
        Axios.get("https://api.openweathermap.org/data/2.5/weather?q=amsterdam&units=metric&appid=09214dedee32fc1a66f4a5ce580b9e5c").then((response) => {
...
export default AmsterdamWeather;
